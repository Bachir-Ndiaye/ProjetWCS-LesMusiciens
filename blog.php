...
<div class="picture-all">
    <div class="picture">  
            <div class="identity-picture-one">
                <img class="imgblog" src="/src/img/backshot-hipster.jpg" alt="musicien sur la plage">
    ...
    <div class="picture">
            <div class="identity-picture-two">
                <img class="imgblog" src="/src/img/batteur-professionnel.jpg" alt="batteur ">
                <div class="texte-picture">
    ...
    <div class="picture">
            <div class="identity-picture-tree">
                <img class="imgblog" src="/src/img/deux-rappeurs.jpg" alt="deux rapeur">
                <div class="texte-picture">
    ...
    <div class="picture">
            <div class="identity-picture-four">
                <img class="imgblog" src="/src/img/fille-punk-vetue-pantalon-cuir.jpg" alt="fille punk">
                <div class="texte-picture">
    ...
    <div class="picture">
            <div class="identity-picture-five">
                <img class="imgblog" src="/src/img/jeunes-gens-danser.jpg" alt="musicien classic">
                <div class="texte-picture">
    ...
    <div class="picture">
            <div class="identity-picture-six">
                <img class="imgblog" src="/src/img/musiciens-rap.jpg" alt="musicien hip hop">
                <div class="texte-picture">
